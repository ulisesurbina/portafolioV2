...
import bgGreen from "./images/backgroundGreenCircle.webp"


function Body({ darkMode }) {
    return (
      <div id="section1" className="BodyWeb">
        <img className="BgGreenOne PositionCircle" src={bgGreen} alt="circle green" />
        <img className="BgGreenTwo PositionCircle" src={bgGreen} alt="circle green" />
        <img className="BgGreenThree PositionCircle" src={bgGreen} alt="circle green" />
        <img className="BgGreenFour PositionCircle" src={bgGreen} alt="circle green" />
        <img className="BgGreenFive PositionCircle" src={bgGreen} alt="circle green" />
        ...
        <section id="section3" className="SectionSkills">
          ...
          <div className="ContainerSwiper">
            ...
            <div className="ItemSlide">
                <div className="Flip-card-inner">
                    <div className="Flip-card-front">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 128 128"><defs><linearGradient id="IconifyId1936f55ee0319567a10" x1="9" x2="9" y1="16.97" y2="1.03" gradientTransform="scale(7.11111)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#0078d4"/><stop offset=".16" stopColor="#1380da"/><stop offset=".53" stopColor="#3c91e5"/><stop offset=".82" stopColor="#559cec"/><stop offset="1" stopColor="#5ea0ef"/></linearGradient></defs><path fill="url(#IconifyId1936f55ee0319567a10)" d="M120.89 28.445v69.262l-28.445 23.324l-44.09-16.07v15.93L23.395 88.25l72.746 5.688V31.574ZM96.64 31.93L55.82 7.11v16.285L18.348 34.418L7.109 48.852v32.785l16.075 7.11V46.718Zm0 0"/></svg>
                    </div>
                    <div className="Flip-card-back">
            ...
            <div className="ItemSlide">
                <div className="Flip-card-inner">
                    <div className="Flip-card-front">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 256 221"><path fill="#41B883" d="M204.8 0H256L128 220.8L0 0h97.92L128 51.2L157.44 0z"/><path fill="#41B883" d="m0 0l128 220.8L256 0h-51.2L128 132.48L50.56 0z"/><path fill="#35495E" d="M50.56 0L128 133.12L204.8 0h-47.36L128 51.2L97.92 0z"/></svg>
                    </div>
                    <div className="Flip-card-back">
